...
<h1 align="center">
  Gatsby's default starter with TypeScript, Twin.Macro and Storybook
</h1>

Kick off your project with this boilerplate. This starter ships with the main Gatsby configuration files, based on the [gatsby-default-starter](https://github.com/gatsbyjs/gatsby-starter-default), you might need to get up and running blazing fast with the blazing fast app generator for React.
